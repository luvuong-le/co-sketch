...
help:
	...
	@echo '  compose           build docker images for production or development using docker-compose'
	@echo '  build     	    build docker images for production or development'
	@echo '  compose-run       run docker containers with docker-compose'
	@echo '  run  		    run docker containers'
	@echo '  clear    	    stops and removes docker images'
	@echo '  stop    	    stops docker containers'
	@echo '  remove    	    removes the docker containers'
	@echo '  clean    	    remove docker'
